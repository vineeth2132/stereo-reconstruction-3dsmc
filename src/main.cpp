...
int main()
{
	...
	*/
	...
	cv::Mat gtDepthRaw = dataLoader.LoadGroundTruthDepthMap(gtDepthRelativePath, 6048, 4032); // 6048x4032 hardcoded, i know it's not good but the resolution of the raw images are required. -emircan
